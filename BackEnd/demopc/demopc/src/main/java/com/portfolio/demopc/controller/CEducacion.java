 ...
 */
package com.portfolio.demopc.controller;


import com.portfolio.demopc.Dto.dtoEducacion;
import com.portfolio.demopc.Entity.Educacion;
import com.portfolio.demopc.mensaje.Mensaje;
import com.portfolio.demopc.service.Seducacion;
...
public class CEducacion {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> create(@Valid @RequestBody dtoEducacion dtoeducacion){
...
/*    if(StringUtils.isBlank(dtoeducacion.getTitulo())){
    ...
    Educacion educacion= new Educacion(dtoeducacion.getTitulo(),dtoeducacion.getTipoeducacion(),dtoeducacion.getInstitucion(),dtoeducacion.getIcono(),dtoeducacion.getinicio(),dtoeducacion.getfin(),dtoeducacion.isCursando());
 ...
 /*   if(StringUtils.isBlank(dtoeducacion.getTitulo())){
    ...
    educacion.setTipoeducacion(dtoeducacion.getTipoeducacion());
    educacion.setInstitucion(dtoeducacion.getInstitucion());
    educacion.setIcono(dtoeducacion.getIcono());
    educacion.setInicio(dtoeducacion.getinicio());
    educacion.setFin(dtoeducacion.getfin());
    educacion.setCursando(dtoeducacion.isCursando());
